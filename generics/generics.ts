// passar um tipo como parametro para um função ou classe
// sintaxe => usa <> para informar o tipo

const first = (array) => {
    return array[0]
}

const last = <ArrayType>(array: ArrayType[]): ArrayType | undefined => {
    return array[array.length - 1]
}

const pilots = ['Luke', 'Han', 'Biggs']

// retorna type any
const firstPilot = first(pilots)
// retorna o tipo correto, string
...
// usando generics, o retorno será do tipo correto no copy2
